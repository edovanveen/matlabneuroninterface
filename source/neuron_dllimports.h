...
#include "neuron_api_headers.h"
    ...
    extern "C" dvptrint_function hoc_call_func;
    extern "C" voptrsptri_function hoc_call_ob_proc;
    extern "C" dsio_function hoc_call_objfunc;
    extern "C" vsptr_function hoc_install_object_data_index;
    extern "C" scptr_function hoc_lookup;
    extern "C" voptr_function hoc_obj_ref;
    extern "C" voptr_function hoc_obj_unref;
    extern "C" Objectdata* hoc_objectdata;
    extern "C" optrptrv_function hoc_objpop;
    extern "C" icptr_function hoc_oc;
    extern "C" voptrptr_function hoc_pushobj;
    extern "C" vdptr_function hoc_pushpx;
    extern "C" vcptrptr_function hoc_pushstr;
    extern "C" vd_function hoc_pushx;
    extern "C" vv_function hoc_ret;
    extern "C" cptrptrv_function hoc_strpop;
    extern "C" scptrslptr_function hoc_table_lookup;
    extern "C" voptrptr_function hoc_tobj_unref;
    extern "C" Objectdata* hoc_top_level_data;
    extern "C" Symlist* hoc_top_level_symlist;
    extern "C" dv_function hoc_xpop;
    extern "C" int nrn_is_python_extension;
    extern "C" int nrn_main_launch;
    extern "C" int nrn_nobanner_;
    extern "C" nptrsecptrd_function node_exact;
    extern "C" vv_function nrn_popsec;
    extern "C" vsecptr_function nrn_pushsec;
    extern "C" vf2icif_function nrnpy_set_pr_etal;
    extern "C" ppoptr_function ob2pntproc_0;
    extern "C" ivptr_function vector_capacity;
    extern "C" dptrvptr_function vector_vec;
#endif
